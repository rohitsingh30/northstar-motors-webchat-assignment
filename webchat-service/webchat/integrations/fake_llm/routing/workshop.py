...
class WorkshopRouter:
    """Routes service discovery, availability, booking, and verified lookup requests."""
    ...
    def route(self, context: ConversationContext) -> ProviderReply | None:
        ...
        # Free-form service questions continue through the remaining offline routes. Keep
        # the explicit action text as a compatibility fallback; current chips carry a typed action.
